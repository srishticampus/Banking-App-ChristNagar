...
function ManagerViewVerifiedInsurance() {
                            ...
                            <tr className="CMCC-Table-tbody-tr" key={index}>
                              ...
                              <td className="CMCC-Table-td-center">
                                <div
                                  onClick={() =>
                                    navigate(
                                      `/manager/managerviewinsurancedetails/${data._id}`
                                    )
                                  }
                                >
                        ...
                        return (
                          <tr className="CMCC-Table-tbody-tr" key={index}>
                            ...
                            <td className="CMCC-Table-td-center">
                              <div
                                onClick={() =>
                                  navigate(`/manager/managerviewinsurancedetails/${data._id}`)
                                }
                              >
                                <img src={img2} alt="View Details" />
                              </div>
...
export default ManagerViewVerifiedInsurance;
